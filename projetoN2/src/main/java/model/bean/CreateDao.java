...
public class CreateDao {
    ...
    public static void create(DiaApanha a) 
    {
        ...
        try {
            ...
            cl.setTime(dat);
            stmt = con.prepareStatement("INSERT INTO dias_safra_"+cl.get(Calendar.YEAR)+" (idDias_safra,CajuBom, PBom, CajuPoupa, PPoupa, Pago)VALUES(?,?,?,?,?,?)");
            stmt.setDate(1, dt);
