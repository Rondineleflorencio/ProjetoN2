...
{
    public static void update(DiaApanha a) 
    {
        ...
        try {
            ...
            cl.setTime(dat);
            stmt = con.prepareStatement("UPDATE dias_safra_"+cl.get(Calendar.YEAR)+" SET CajuBom = ?, PBom = ?, CajuPoupa = ?, PPoupa = ?, Pago = ? WHERE idDias_safra = ?");
